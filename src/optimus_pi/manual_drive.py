...
from .config import LEFT_PINS, RIGHT_PINS, DEFAULT_CONTROLLER_CONFIGURATION, CONTROLLER_CONFIGURATION_FILE
...
class ManualDrive(Controller):
    ...
    def __init__(self, **kwargs):
        ...
        if CONTROLLER_CONFIGURATION_FILE.exists():
            self.max_joystick_values = json.loads(CONTROLLER_CONFIGURATION_FILE.read_text())
        else:
            self.max_joystick_values = DEFAULT_CONTROLLER_CONFIGURATION
